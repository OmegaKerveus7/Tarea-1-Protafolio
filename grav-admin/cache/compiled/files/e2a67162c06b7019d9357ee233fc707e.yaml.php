...
return [
    ...
    'filename' => 'C:/Users/tobia/Desktop/Programas/Programas VSC/DesarrolloWeb/Clase 1/Tarea 1/grav-admin/system/blueprints/pages/default.yaml',
    'modified' => 1784090298,
    'size' => 12233,
    'data' => [
                                ...
                                'overrides' => [
                                    ...
                                    'fields' => [
                                        ...
                                        'header.external_url' => [
                                            ...
                                            'toggleable' => true,
                                            'help' => 'PLUGIN_ADMIN.EXTERNAL_URL_HELP',
                                        ...
                                        'header.process' => [
                                            ...
                                            'toggleable' => true,
                                            'data-default@' => '\\Grav\\Common\\Security::pageProcessDefaults',
                                            'data-options@' => '\\Grav\\Common\\Security::pageProcessOptions',
                                            'use' => 'keys'
                                        ],
                                        'header.twig_first' => [
                                            'type' => 'toggle',
                                    ...
                                    'fields' => [
                                        'header.admin.children_display_order' => [
                                            ...
                                            'options' => [
                                                ...
                                                'default' => 'Ordered by Folder name'
                                            ]
                                        ],
                                        'header.order_by' => [
                                            'type' => 'hidden'
