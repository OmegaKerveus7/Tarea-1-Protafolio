...
return [
    ...
    'filename' => 'C:/Users/tobia/Desktop/Programas/Programas VSC/DesarrolloWeb/Clase 1/Tarea 1/grav-admin/system/blueprints/flex/pages.yaml',
    'modified' => 1784090298,
    'size' => 5008,
    'data' => [
        'title' => 'Pages',
        ...
        'config' => [
            'admin' => [
                ...
                'permissions' => [
                    'admin.pages' => [
                        'type' => 'crudl',
                        'label' => 'PLUGIN_ADMIN.PAGES'
                    ],
                    'admin.configuration.pages' => [
                        'type' => 'default',
                        'label' => 'PLUGIN_ADMIN.PAGES_CONFIGURATION'
                    ]
                ],
                'menu' => [
                    'list' => [
                ...
                'list' => [
                    'fields' => [
                        ...
                        'translations' => [
                            'width' => 8,
                            'field' => [
                                'label' => 'PLUGIN_ADMIN.TRANSLATIONS',
                                'type' => 'text'
                            ]
                        ]
                    ],
