...
return [
    ...
    'filename' => 'C:/Users/tobia/Desktop/Programas/Programas VSC/DesarrolloWeb/Clase 1/Tarea 1/grav-admin/system/blueprints/flex/user-accounts.yaml',
    'modified' => 1784090298,
    'size' => 3701,
    'data' => [
        'title' => 'User Accounts',
        ...
        'config' => [
            'admin' => [
                ...
                'permissions' => [
                    'admin.users' => [
                        'type' => 'crudl',
                        'label' => 'PLUGIN_ADMIN.USER_ACCOUNTS'
                    ],
                    'admin.configuration.users' => [
                        'type' => 'default',
                        'label' => 'PLUGIN_ADMIN.ACCOUNTS_CONFIGURATION'
                    ]
                ],
                'menu' => [
                    'base' => [
